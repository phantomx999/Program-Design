...
TEST_F(DateTest, OperatorAdditionTest) {
  ...
  EXPECT_EQ((y2k.operator+(0)).GetUsDate(), "1999-12-31") << "y2k operator+0 fail";
  EXPECT_EQ((ind_day.operator+(0)).GetUsDate(), "1776-07-04") << "ind_day operator+0 fail";
  EXPECT_EQ((best_holiday.operator+(0)).GetUsDate(), "2018-10-31") << "best_holiday operator+0 fail"; 
  EXPECT_EQ((y2k.operator+(0)).GetDate(), "12-31-1999") << "y2k operator+0 fail 2";
  EXPECT_EQ((ind_day.operator+(0)).GetDate(), "07-04-1776") << "ind_day operator+0 fail 2";
  EXPECT_EQ((best_holiday.operator+(0)).GetDate(), "10-31-2018") << "best_holiday operator+0 fail 2"; 

  EXPECT_EQ((y2k.operator+(1)).GetUsDate(), "2000-01-01") << "y2k operator+1 fail";
  EXPECT_EQ((ind_day.operator+(1)).GetUsDate(), "1776-07-05") << "ind_day operator+1 fail";
  EXPECT_EQ((best_holiday.operator+(1)).GetUsDate(), "2018-11-01") << "best_holiday operator+1 fail"; 
  EXPECT_EQ((y2k.operator+(1)).GetDate(), "01-01-2000") << "y2k operator+1 fail 2";
  EXPECT_EQ((ind_day.operator+(1)).GetDate(), "07-05-1776") << "ind_day operator+1 fail 2";
  EXPECT_EQ((best_holiday.operator+(1)).GetDate(), "11-01-2018") << "best_holiday operator+1 fail 2"; 

  EXPECT_EQ((y2k.operator+(-1)).GetUsDate(), "1999-12-30") << "y2k operator+(-1) fail";
  EXPECT_EQ((ind_day.operator+(-1)).GetUsDate(), "1776-07-03") << "ind_day operator+(-1) fail";
  EXPECT_EQ((best_holiday.operator+(-1)).GetUsDate(), "2018-10-30") << "best_holiday operator+(-1) fail"; 
  EXPECT_EQ((y2k.operator+(-1)).GetDate(), "12-30-1999") << "y2k operator+(-1) fail 2";
  EXPECT_EQ((ind_day.operator+(-1)).GetDate(), "07-03-1776") << "ind_day operator+(-1) fail 2";
  EXPECT_EQ((best_holiday.operator+(-1)).GetDate(), "10-30-2018") << "best_holiday operator+(-1) fail 2"; 
  ...
  EXPECT_EQ((day_test1.operator+(1)).GetUsDate(), "1999-05-01") << "day_test1 operator+(1) fail";
  EXPECT_EQ((day_test1.operator+(1)).GetDate(), "05-01-1999") << "day_test1 operator+(1) fail 2";
  EXPECT_EQ((day_test1.operator+(-1)).GetUsDate(), "1999-04-29") << "day_test1 operator+(-1) fail 3";
  EXPECT_EQ((day_test1.operator+(-1)).GetDate(), "04-29-1999") << "day_test1 operator+(-1) fail 4";

  EXPECT_EQ((day_test2.operator+(1)).GetUsDate(), "2000-01-02") << "day_test2 operator+(1) fail"; 
  EXPECT_EQ((day_test2.operator+(1)).GetDate(), "01-02-2000") << "day_test2 operator+(1) fail 2";
  EXPECT_EQ((day_test2.operator+(-1)).GetUsDate(), "1999-12-31") << "day_test2 operator+(-1) fail 3"; 
  EXPECT_EQ((day_test2.operator+(-1)).GetDate(), "12-31-1999") << "day_test2 operator+(-1) fail 4";

  EXPECT_EQ((day_test3.operator+(1)).GetUsDate(), "1900-01-02") << "day_test3 operator+(1) fail";
  EXPECT_EQ((day_test3.operator+(1)).GetDate(), "01-02-1900") << "day_test3 operator+(1) fail 2";
  EXPECT_EQ((day_test3.operator+(-1)).GetUsDate(), "1899-12-31") << "day_test3 operator+(-1) fail 3";
  EXPECT_EQ((day_test3.operator+(-1)).GetDate(), "12-31-1899") << "day_test3 operator+(-1) fail 4";

  EXPECT_EQ((day_test4.operator+(1)).GetUsDate(), "0000-01-01") << "day_test4 operator+(1) fail"; 
  EXPECT_EQ((day_test4.operator+(1)).GetDate(), "01-01-0000") << "day_test4 operator+(1) fail 2";
  EXPECT_EQ((day_test4.operator+(-1)).GetUsDate(), "9999-12-30") << "day_test4 operator+(-1) fail 3"; 
  EXPECT_EQ((day_test4.operator+(-1)).GetDate(), "12-30-9999") << "day_test4 operator+(-1) fail 4";

  EXPECT_EQ((month_test1.operator+(30)).GetUsDate(), "1776-12-01") << "month_test1 operator+(30) fail";
  EXPECT_EQ((month_test1.operator+(30)).GetDate(), "12-01-1776") << "month_test1 operator+(30) fail 2";
  EXPECT_EQ((month_test1.operator+(-31)).GetUsDate(), "1776-10-01") << "month_test1 operator+(-31) fail 3";
  EXPECT_EQ((month_test1.operator+(-31)).GetDate(), "10-01-1776") << "month_test1 operator+(-31) fail 4";
 
  EXPECT_EQ((month_test2.operator+(31)).GetUsDate(), "2001-01-31") << "month_test2 operator+(31) fail";
  EXPECT_EQ((month_test2.operator+(31)).GetDate(), "01-31-2001") << "month_test2 operator+(31) fail 2";
  EXPECT_EQ((month_test2.operator+(-31)).GetUsDate(), "2000-11-30") << "month_test2 operator+(-31) fail 3";
  EXPECT_EQ((month_test2.operator+(-31)).GetDate(), "11-30-2000") << "month_test2 operator+(-31) fail 4";

  EXPECT_EQ((year_test1.operator+(365)).GetUsDate(), "1999-01-01") << "year_test1 operator+(365) fail"; 
  EXPECT_EQ((year_test1.operator+(365)).GetDate(), "01-01-1999") << "year_test1 operator+(365) fail 2";
  EXPECT_EQ((year_test1.operator+(-365)).GetUsDate(), "1997-01-01") << "year_test1 operator+(-365) fail 3";
  EXPECT_EQ((year_test1.operator+(-365)).GetDate(), "01-01-1997") << "year_test1 operator+(-365) fail 4";

  EXPECT_EQ((year_test2.operator+(365)).GetUsDate(), "2000-01-01") << "year_test2 operator+(365) fail"; 
  EXPECT_EQ((year_test2.operator+(365)).GetDate(), "01-01-2000") << "year_test2 operator+(365) fail 2";
  EXPECT_EQ((year_test2.operator+(-365)).GetUsDate(), "1998-01-01") << "year_test2 operator+(-365) fail 3";
  EXPECT_EQ((year_test2.operator+(-365)).GetDate(), "01-01-1998") << "year_test2 operator+(-365) fail 4"; 

  EXPECT_EQ((year_test3.operator+(365)).GetUsDate(), "2000-12-31") << "year_test3 operator+(365) fail"; 
  EXPECT_EQ((year_test3.operator+(365)).GetDate(), "12-31-2000") << "year_test3 operator+(365) fail 2";
  EXPECT_EQ((year_test3.operator+(-365)).GetUsDate(), "1998-12-31") << "year_test3 operator+(-365) fail 3";
  EXPECT_EQ((year_test3.operator+(-365)).GetDate(), "12-31-1998") << "year_test3 operator+(-365) fail 4";  
...
TEST_F(DateTest, DaysBetweenTests) {
  ...
  EXPECT_EQ(date1.DaysBetween(date2), 365) << "date1 to date2 incorrect for DaysBetween()";
  EXPECT_EQ(date2.DaysBetween(date3), 366) << "date2 to date3 leap year failure in DaysBetween()";
