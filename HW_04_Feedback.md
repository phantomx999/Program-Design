...
+ Fail: Check that directory "HW/HW04" exists.

     "HW/HW04" not found.

+ Skip: Make directory "HW04_Testing".

  This test was not run because of an earlier failing test.

+ Skip: Change into directory "HW04_Testing".
...
+ Skip: Copy directory "Google Tests".
...
+ Skip: Check that file "../HW/HW04/date_unittest.cc" exists.
...
+ Skip: Copy directory "HW04 files.".
